...
void makeBottomPlatform() {
  ...
  bottomPlatform.vertex(width/2 -330, height*0.6);
  bottomPlatform.vertex(width/2 -300, height*0.6);
  bottomPlatform.vertex(width/2-230, height*0.9);
  bottomPlatform.vertex(width/2+230, height*0.9);
  bottomPlatform.vertex(width/2 +300, height*0.6);
  bottomPlatform.vertex(width/2 +330, height*0.6);
  bottomPlatform.vertex(width/2+230,height);
  bottomPlatform.vertex(width/2-230,height);
  //bottomPlatform.vertex(width/2-200, height);
